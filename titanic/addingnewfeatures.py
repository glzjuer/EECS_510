...
def clean(no_bins=0):
    ...
    trainpath = '~/Documents/510 Social Media Mining/train.csv'
    testpath = '~/Documents/510 Social Media Mining/test.csv'
    ...
    predictiondf.to_csv('~/Documents/510 Social Media Mining/prediction.csv',
                  index=False)
